...
保存规则：
- 生成完整 Markdown 报告后，必须保存到 /Users/jiexinlv/Documents/CortexOps/state/weekly/demo-replication/YYYY-MM-DD-demo-replication-recommendation.md。
- YYYY-MM-DD 使用 Asia/Shanghai 运行时日期。
- 若目录不存在，先创建 /Users/jiexinlv/Documents/CortexOps/state/weekly/demo-replication。
